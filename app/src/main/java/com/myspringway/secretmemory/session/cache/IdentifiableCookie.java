...
package com.myspringway.secretmemory.session.cache;
...
class IdentifiableCookie {
    ...
    static List<com.myspringway.secretmemory.session.cache.IdentifiableCookie> decorateAll(Collection<Cookie> cookies) {
        List<com.myspringway.secretmemory.session.cache.IdentifiableCookie> identifiableCookies = new ArrayList<>(cookies.size());
        for (Cookie cookie : cookies) {
            identifiableCookies.add(new com.myspringway.secretmemory.session.cache.IdentifiableCookie(cookie));
        }
    ...
    public boolean equals(Object other) {
        if (!(other instanceof com.myspringway.secretmemory.session.cache.IdentifiableCookie)) return false;
        com.myspringway.secretmemory.session.cache.IdentifiableCookie that = (com.myspringway.secretmemory.session.cache.IdentifiableCookie) other;
